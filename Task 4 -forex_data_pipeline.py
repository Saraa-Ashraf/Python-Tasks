...
def download_rates():
    with open('/home/sara/Desktop/forex_data_pipeline/mnt/airflow/dags/files/forex_currencies.csv') as forex_currencies:
        ...
        for row in reader:
            ...
            with open('/home/sara/Desktop/forex_data_pipeline/mnt/airflow/dags/files/forex_rates.json', 'a') as outfile:
...
#a3ml run l python_callable en feha el rates bt3ty
...
#Spark job to process the script
    forex_processing = SparkSubmitOperator(
        task_id="forex_processing",
        conn_id="spark_conn",
        application="('/home/sara/Desktop/forex_data_pipeline/mnt/airflow/dags/files/forex_processing.py",
        verbose=False
    )
